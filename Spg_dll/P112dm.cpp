// P112dm.cpp: implementation of the P112dm class.
//
//////////////////////////////////////////////////////////////////////
...
P112dm::P112dm()
{
	this->m_pageInInternationalTables = "p.152";
	this->m_SpaceGroupNumber = 10001;
	this->m_Short_notation = "P2/m";
	this->m_Long_notation = "P112/m";
...
// n
	m_Coordinates[4] = "x,y,1/2";
	m_Coordinates[5] = "-x,-y,1/2";
// m
	m_Coordinates[6] = "x,y,0";
	m_Coordinates[7] = "-x,-y,0";
// l
	m_Coordinates[8] = "1/2,1/2,z";
	m_Coordinates[9] = "1/2,1/2,-z";
// k
	m_Coordinates[10] = "1/2,0,z";
	m_Coordinates[11] = "1/2,0,-z";
// j
	m_Coordinates[12] = "0,1/2,z";
	m_Coordinates[13] = "0,1/2,-z";
// i
	m_Coordinates[14] = "0,0,z";
	m_Coordinates[15] = "0,0,-z";
// h
	m_Coordinates[16] = "1/2,1/2,1/2";
// g
	m_Coordinates[17] = "1/2,1/2,0";
// f
	m_Coordinates[18] = "1/2,0,1/2";
// e
	m_Coordinates[19] = "0,1/2,1/2";
// d
	m_Coordinates[20] = "0,1/2,0";
// c
	m_Coordinates[21] = "1/2,0,0";
// b
	m_Coordinates[22] = "0,0,1/2";
// a
...
////////////////////////////////////////////////////////////////////////
//
EqPositions* P112dm::GetEqPos(double xyz[3], char Wpos)
{
